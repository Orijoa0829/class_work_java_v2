...
public class BackgroundPlayerService implements Runnable {
    ...
    // start() 메서드가 호출 되면 동작 하도록 약속되어 있다
    @Override
    public void run() {
        while(true){
            //RGB
            ...
            //위 두 조건이 아니면 하얀색.. 하얀색 일 때에는 마음대로 움직일 수 있다.
